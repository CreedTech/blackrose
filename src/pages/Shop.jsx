...
//   if (error) {
//     return (
//       <div className="min-h-screen bg-light text-dark flex items-center justify-center px-4">
...
//             />
//             <div className="absolute inset-y-0 left-0 w-full max-w-sm  shadow-xl  overflow-y-auto">
...
//         {/* Controls Bar */}
//         <div className="bg-gradient-to-r from-[#f4f4f4] via-[#faf8f8] to-[#f4f4f4] rounded-xl shadow-md border border-gray-50  p-3 md:p-4 mb-4 md:mb-6">
//           <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
//             {/* Left section - Filter button and product count */}
//             <div className="flex items-center justify-between sm:justify-start gap-4">
//               <button
//                 onClick={() => setShowFilters(!showFilters)}
//                 className="flex items-center gap-2 px-3 md:px-4 py-2 border border-primary rounded-lg hover:border-white transition lg:hidden text-sm md:text-base"
//               >
//                 <FaFilter />
//                 Filters
//               </button>
...
//                 {data?.pagination?.totalProducts || 0} product{' '}
//                 {data?.pagination?.totalProducts > 1 ? 's' : ''}
//               </span>
//             </div>
...
//                 }
//                 className="px-3 md:px-4 py-2 bg-light border border-gray-400 rounded-lg focus:outline-none focus:border-primary transition text-sm md:text-base flex-1 sm:flex-none min-w-0"
//               >
...
//               <div className="md:flex gap-1 hidden md:gap-2">
//                 <button
...
//                   className={`${
//                     viewMode === 'grid'
//                       ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-3 md:gap-4 lg:gap-6'
