...
//   if (viewMode === 'list') {
//     return (
//       <div className="bg-main rounded-lg overflow-hidden shadow-xl transition-shadow">
...
//               <Link
//                 to={`/shop/${product._id}`}
//                 className="text-base md:text-xl font-semibold hover:text-gray-300 transition line-clamp-2 pr-2"
//               >
//                 {product.title}
//               </Link>
//               <button
//                 onClick={handleWishlistToggle}
//                 className="text-gray-700 hover:text-gray-900 transition flex-shrink-0 p-1"
//               >
...
//                   {product.discount > 0 && (
//                     <>
//                       <span className="text-xs md:text-sm text-gray-700 line-through">
//                         {currency}
...
//                 className={`relative px-3 md:px-6 py-2 rounded-md overflow-hidden transition-all flex items-center gap-2 text-sm md:text-base justify-center group ${
//                   product.stock === 0
//                     ? 'bg-gray-700 text-gray-400 cursor-not-allowed'
//                     : 'bg-white text-black hover:text-light font-medium'
//                 }`}
//               >
//                 {/* Hover background animation layer */}
//                 {product.stock !== 0 && (
//                   <span className="absolute inset-0 bg-gray-800  w-0 group-hover:w-full transition-all duration-300 ease-in-out z-0"></span>
//                 )}

//                 {/* Content must be above animated background */}
...
//   // Grid View
//   return (
//     <div className="bg-main rounded-lg overflow-hidden shadow-xl transition-all group">
...
//         <Link
//           to={`/shop/${product._id}`}
//           className=" hover:text-gray-900 transition line-clamp-2 text-md font-semibold md:text-2xl mb-1"
//         >
//           {product.title}
//         </Link>
...
//               </span>
//               {product.discount > 0 && (
//                 <span className="text-xs md:text-sm text-gray-700 font-medium line-through">
//                   {currency}
//                   {product.price.toLocaleString()}
//                 </span>
//               )}
