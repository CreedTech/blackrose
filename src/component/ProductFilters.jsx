...
//     return (
//       <div
//         className={`border-b border-gray-700 last:border-b-0 relative ${className}`}
//       >
//         <button
...
//             )} */}
//             {isExpanded ? (
//               <FaChevronUp className="text-xs text-gray-700" />
//             ) : (
...
//   return (
//     <div className="bg-gradient-to-r from-[#f4f4f4] via-[#ffffff] to-[#f4f4f4] rounded-xl border border-gray-50  overflow-hidden shadow-xl ">
//       {/* Header */}
//       <div className="flex justify-between items-center p-4 md:p-6 border-b border-gray-400">
//         <div className="flex items-center gap-2">
...
//             className="text-xs md:text-sm text-gray-700 hover:text-primary font-medium transition px-2 py-1 rounded"
//           >
//             Clear All
//           </button>
//           <button
//             onClick={onClose}
//             className="lg:hidden text-gray-700 hover:text-primary p-1"
//           >
...
//                     <label
//                       key={category._id}
//                       className="flex items-center cursor-pointer hover:text-gray-600 transition"
//                     >
//                       <input
//                         type="radio"
//                         name="category"
...
//                       className="mr-3 w-4 h-4 accent-primary"
//                     />
//                     <span className="text-sm md:text-base font-normal">{range.label}</span>
//                   </label>
//                 );
//               })}
//             </div>
...
//                     className="mr-2 md:mr-3 w-4 h-4 accent-primary"
//                   />
//                   <span className="text-sm md:text-base font-normal">{color}</span>
//                 </label>
//               ))}
//             </div>
//           </FilterSection>
...
//                     className="mr-3 w-4 h-4 accent-primary"
//                   />
//                   <span className="text-sm md:text-base font-normal">{material}</span>
//                 </label>
//               ))}
//             </div>
//           </FilterSection>
...
//                     className="mr-3 w-4 h-4 accent-primary"
//                   />
//                   <span className="text-sm md:text-base font-normal">{feature}</span>
//                 </label>
//               ))}
//             </div>
//           </FilterSection>
...
//             <label className="flex items-center cursor-pointer hover:text-gray-600 transition">
//               <input
//                 type="checkbox"
...
//                 className="mr-3 w-4 h-4 accent-primary"
//               />
//               <span className="text-sm md:text-base font-normal">In Stock Only</span>
//             </label>
//           </FilterSection>
//         </div>
//       </div>
